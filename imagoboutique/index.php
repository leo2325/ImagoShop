...
/*
 Create a global constant used to get the filesystem 
 path to the application configuration directory.
 */
define('CFG_PATH', realpath(ROOT_PATH.'/application/config'));

/* 
 Create a global constant used to get the filesystem path to the application public web root directory.
